...
<div id="content">
    <div class="container-fluid table-block">
                <div class="row table-cell-block">
                        <h1 class="text-center login-title" style="margin:10% 0% 0% 47%" >Вход</h1>
                        <div class="account-wall">
                            ...
                            <input type="hidden" name="action" value="login"> 
                                ...
                                <br/>
                                <input type="submit" class="btn btn-lg btn-primary" style="margin:10% 0% 0% 35%" value="авторизация"/>
                            </form>
                            <a href="views/add.ttt.php" class="text-center new-account" style="margin:5% 0% 0% 43%">Create account</a>
                        </div> 
                </div>
    </div>
</div>
